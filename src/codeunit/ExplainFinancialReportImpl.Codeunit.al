/// <summary>
/// Codeunit Explain Financial Report Impl. (ID 50101).
/// </summary>
codeunit 50101 "Explain Financial Report Impl."
{
    ...
    /// SetOptions.
    /// </summary>
    /// <param name="AccSchedLineFrom">VAR Record "Acc. Schedule Line".</param>
    /// <param name="ColumnLayoutNameFrom">Code[10].</param>
    /// <param name="UseAmtsInAddCurrFrom">Boolean.</param>
    ...
    /// SuggestExplanation.
    /// </summary>
    /// <param name="SuggestedExplanationText">VAR Text.</param>
